...
- **Software Development**
  ...
  - Polish is part of the MVP (Minimum Viable Product).
...
- **Organizational Vision**  
  My goal is for everyone in the organization to understand why their work matters and how it drives the business forward.
...
<Callout
  ...
  description={[
    ...
    "This is inspired from Malte Ubl's handbook post - https://www.industrialempathy.com/posts/malte-handbook",
  ]}
/>
