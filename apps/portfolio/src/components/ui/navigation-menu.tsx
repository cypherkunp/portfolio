...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Content
    ...
    className={cn(
      ...
      data-[motion=to-start]:slide-out-to-left-52 left-0 top-0 w-full md:absolute md:w-auto`,
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Link
    ref={ref}
    className={cn(
      'dark:[!text-yellow-300] dark:hover:[!text-purple-500] active:[!text-purple-500]',
      className,
    )}
    {...props}
  />
  ...
  <div className={cn('absolute left-0 top-full flex justify-center')}>
    <NavigationMenuPrimitive.Viewport
      className={cn(
        ...
        border-zinc-200 bg-white text-zinc-950 shadow-lg md:w-[var(--radix-navigation-menu-viewport-width)]
